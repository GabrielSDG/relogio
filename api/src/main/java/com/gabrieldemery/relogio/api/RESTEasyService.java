...
public class RESTEasyService extends Application {
    ...
    public RESTEasyService() {
        ...
        Reflections reflections = new Reflections(new ConfigurationBuilder()
                ...
                .filterInputsBy(new FilterBuilder().include(FilterBuilder.prefix("com.gabrieldemery.relogio.api"))));
        ...
        for (Class clazz : allClasses) {
            try {
                ...
                LOG.error("Erro ao instanciar objeto da classe "+clazz.getName(), e);
